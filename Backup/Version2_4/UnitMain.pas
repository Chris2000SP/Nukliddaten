...
uses
  ...
  JvExExtCtrls, JvRadioGroup, JvCombobox, SpecLib, CheckLst, JvRollOut,
  HTMLLite;
...
begin
  ...
  begin
    ...
    begin
      ...
      StatusBar.Panels[0].Text := 'Taste F1 drücken für Hilfe'
    else StatusBar.Panels[0].Text := '';
  end
...
begin
  ...
  temp := InputBox('Suche Nuklid',
    ...
    #13#10 + '(Groß- und Kleinschreibung beachten!)','');
