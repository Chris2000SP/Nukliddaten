...
begin
  ...
  Result := Result + '<BR><FONT SIZE="3">14.01.2010 von Holger Werner</CENTER>' +
  '<font size="-1"><center><a href="mailto:nukliddaten@dokom.net">nukliddaten@dokom.net</a></center></font><BR><BR>' +
