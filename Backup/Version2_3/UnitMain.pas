...
uses
  ...
  JvExExtCtrls, JvRadioGroup, JvCombobox, SpecLib, CheckLst;
...
type
  ...
  private
    ...
    RGlast,Zx,AktZ,nochmal,SpecX,SpecY: Integer;
    LongDatum: String;
  public
      ...
      begin
        ...
        begin
          ...
          begin
            ...
            if i < 170 then
            begin
              tw := (TextWidth('N='+IntToStr(i)) - w) div 2;
              TextOut(Rect.Left-tw,Rect.Top-33,'N='+IntToStr(i));
              Pen.Color := clGray;
...
begin
  ...
  CBMagig.Enabled := not MenuZReihe.Checked and not MenuNSpalte.Checked;
end;
