...
type
  ...
  public
    ...
    TVNukIdx,TVRadIdx,bRad,anzrad,XAkt: Integer;
    ...
    PanelMin,PanelTVRad,PanelGamma: TPanel;
...
begin
  ...
  begin
    ...
    if (Sender as TIconGrid).Name <> 'GridRadDat' then ClearGridRadDat;
  end
  else
  begin
    CanShow := False;
...
begin
  ...
  begin
    ...
    begin
      ...
      {Pen.Color := GridReihe.Color;//clGray;
      MoveTo(Rekt.Right,Rekt.Top);
      LineTo(Rekt.Right,Rekt.Bottom);
      MoveTo(Rekt.Left,Rekt.Bottom-1);
      LineTo(Rekt.Right,Rekt.Bottom-1);}
