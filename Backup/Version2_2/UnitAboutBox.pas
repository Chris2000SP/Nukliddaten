...
begin
  ...
  temp :=
    ...
    '<BR>' +
    'Die Alpha-,Beta-,Gamma- und R&ouml;ntgen-Emissions-Daten entsprechen weiterhin' +
    ...
    'Weitere Rückfragen beantwortet gern der Autor von Nukliddaten:<BR>' +
    'Holger Werner<BR>' +
    '<a href="mailto:mail@wernerhk.de">mail@wernerhk.de</a></P>' +
